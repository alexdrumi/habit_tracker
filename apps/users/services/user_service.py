...
class UserService:
	...
	def _validate_user_input(self, user_name: str, user_age=None, user_gender=None, user_role=None, is_update=False):
	...
	def create_a_user(self, user_name: str, user_age: int, user_gender: str, user_role: str) ->dict:
		self._validate_user_input(user_name, user_age, user_gender, user_role)
